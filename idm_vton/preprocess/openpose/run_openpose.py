...
from idm_vton.preprocess.openpose.annotator.util import resize_image, HWC3
from idm_vton.preprocess.openpose.annotator.openpose import OpenposeDetector
...
class OpenPose:
    ...
    def __call__(self, input_image, device, resolution=384):
        ...
        with torch.no_grad():
            ...
            pose, detected_map = self.preprocessor(input_image, device, hand_and_face=False)
