...
If the error comes from idm_vton.detectron2 or torchvision that you built manually from source,
...
If you are running code from idm_vton.detectron2's root directory, `cd` to a different one.
