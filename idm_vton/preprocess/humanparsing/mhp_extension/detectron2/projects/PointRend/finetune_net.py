...
from idm_vton.detectron2.data import MetadataCatalog, build_detection_train_loader
from idm_vton.detectron2.engine import DefaultTrainer, default_argument_parser, default_setup, launch
...
from idm_vton.detectron2.data.datasets import register_coco_instances
