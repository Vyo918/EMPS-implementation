...
from idm_vton.detectron2.layers.rotated_boxes import pairwise_iou_rotated
from idm_vton.detectron2.structures.boxes import Boxes
from idm_vton.detectron2.structures.rotated_boxes import RotatedBoxes, pairwise_iou
