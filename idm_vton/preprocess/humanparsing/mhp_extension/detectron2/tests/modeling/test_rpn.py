...
from idm_vton.detectron2.modeling.proposal_generator.build import build_proposal_generator
from idm_vton.detectron2.modeling.proposal_generator.rpn_outputs import find_top_rpn_proposals
