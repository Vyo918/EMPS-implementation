...
class TestCaffe2Export(unittest.TestCase):
    ...
    def _test_model(self, config_path, device="cpu"):
        ...
        from idm_vton.detectron2.export import Caffe2Model, add_export_config, export_caffe2_model
