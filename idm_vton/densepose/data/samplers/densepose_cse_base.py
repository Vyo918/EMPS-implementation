...
from idm_vton.detectron2.structures import Instances

from idm_vton.densepose.converters.base import IntTupleBox
from idm_vton.densepose.data.utils import get_class_to_mesh_name_mapping
from idm_vton.densepose.modeling.cse.utils import squared_euclidean_distance_matrix
from idm_vton.densepose.structures import DensePoseDataRelative
...
class DensePoseCSEBaseSampler(DensePoseBaseSampler):
    """
    Base DensePose sampler to produce DensePose data from idm_vton.densepose predictions.
