...
from idm_vton.detectron2.structures import BitMasks, Instances

from idm_vton.densepose.converters import ToMaskConverter


class MaskFromDensePoseSampler:
    """
    Produce mask GT from idm_vton.densepose predictions
