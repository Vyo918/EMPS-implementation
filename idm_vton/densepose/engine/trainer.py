...
from idm_vton.detectron2.checkpoint import DetectionCheckpointer
from idm_vton.detectron2.config import CfgNode
from idm_vton.detectron2.engine import DefaultTrainer
from idm_vton.detectron2.evaluation import (
    DatasetEvaluator,
    DatasetEvaluators,
    inference_on_dataset,
    print_csv_format,
)
from idm_vton.detectron2.solver.build import get_default_optimizer_params, maybe_add_gradient_clipping
from idm_vton.detectron2.utils import comm
from idm_vton.detectron2.utils.events import EventWriter, get_event_storage

from idm_vton.densepose import DensePoseDatasetMapperTTA, DensePoseGeneralizedRCNNWithTTA, load_from_cfg
from idm_vton.densepose.data import (
    DatasetMapper,
...
from idm_vton.densepose.evaluation.d2_evaluator_adapter import idm_vton.detectron2COCOEvaluatorAdapter
from idm_vton.densepose.evaluation.evaluator import DensePoseCOCOEvaluator, build_densepose_evaluator_storage
from idm_vton.densepose.modeling.cse import Embedder
