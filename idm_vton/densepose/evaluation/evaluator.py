...
from idm_vton.detectron2.evaluation import DatasetEvaluator
from idm_vton.detectron2.structures import BoxMode
from idm_vton.detectron2.utils.comm import gather, get_rank, is_main_process, synchronize
from idm_vton.detectron2.utils.file_io import PathManager
from idm_vton.detectron2.utils.logger import create_small_table

from idm_vton.densepose.converters import ToChartResultConverter, ToMaskConverter
from idm_vton.densepose.data.datasets.coco import maybe_filter_and_map_categories_cocoapi
from idm_vton.densepose.structures import (
