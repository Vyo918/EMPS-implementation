...
from idm_vton.densepose.data.meshes.catalog import MeshCatalog
from idm_vton.densepose.modeling.cse.utils import normalize_embeddings, squared_euclidean_distance_matrix
