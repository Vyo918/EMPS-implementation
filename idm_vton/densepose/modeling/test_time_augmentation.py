...
from idm_vton.detectron2.data.transforms import RandomRotation, RotationTransform, apply_transform_gens
from idm_vton.detectron2.modeling.postprocessing import detector_postprocess
from idm_vton.detectron2.modeling.test_time_augmentation import DatasetMapperTTA, GeneralizedRCNNWithTTA
...
class DensePoseGeneralizedRCNNWithTTA(GeneralizedRCNNWithTTA):
    ...
    # the implementation follows closely the one from idm_vton.detectron2/modeling
