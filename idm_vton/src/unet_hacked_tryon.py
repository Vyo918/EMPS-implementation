...
from idm_vton.src.unet_block_hacked_tryon import (
    UNetMidBlock2D,
...
from idm_vton.ip_adapter.ip_adapter import Resampler
...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        from idm_vton.ip_adapter.attention_processor import IPAttnProcessor2_0 as IPAttnProcessor, AttnProcessor2_0 as AttnProcessor
