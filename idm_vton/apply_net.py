...
from idm_vton.detectron2.config import CfgNode, get_cfg
from idm_vton.detectron2.data.detection_utils import read_image
from idm_vton.detectron2.engine.defaults import DefaultPredictor
from idm_vton.detectron2.structures.instances import Instances
from idm_vton.detectron2.utils.logger import setup_logger

from idm_vton.densepose import add_densepose_config
from idm_vton.densepose.structures import DensePoseChartPredictorOutput, DensePoseEmbeddingPredictorOutput
from idm_vton.densepose.utils.logger import verbosity_to_level
from idm_vton.densepose.vis.base import CompoundVisualizer
from idm_vton.densepose.vis.bounding_box import ScoredBoundingBoxVisualizer
from idm_vton.densepose.vis.densepose_outputs_vertex import (
    DensePoseOutputsTextureVisualizer,
    DensePoseOutputsVertexVisualizer,
    get_texture_atlases,
)
from idm_vton.densepose.vis.densepose_results import (
    DensePoseResultsContourVisualizer,
    DensePoseResultsFineSegmentationVisualizer,
    DensePoseResultsUVisualizer,
    DensePoseResultsVVisualizer,
)
from idm_vton.densepose.vis.densepose_results_textures import (
    DensePoseResultsVisualizerWithTexture,
    get_texture_atlas,
)
from idm_vton.densepose.vis.extractor import (
    CompoundExtractor,
...
class InferenceAction(Action):
    ...
    def execute(cls: type, args: argparse.Namespace, human_img):
        ...
        cfg.defrost()  # Unfreeze the config to allow modifications
        cfg.MODEL.DEVICE = "cpu"  # Set to CPU
        cfg.freeze()  # Freeze again to prevent unintended modifications
